...
fun Item(
    product: Product = Product()
        ...
        .apply {
            description =
                "Pure cow milk brelkmsd saaklsd d adaskd dajsds dsadjsas dsa d d a sd asd as dqw das d adas"
        }
) {
...
//                .padding(top = 12.dp)) {
//                Text(
//                    text = "Frequency: ${frequency[selectedIndexType]}",
//                    color = colorResource(id = R.color.white)
//                )
//
//            }
